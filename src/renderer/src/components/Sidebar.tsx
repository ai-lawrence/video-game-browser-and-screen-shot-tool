import { MessageSquare, Cpu, Search, Settings as SettingsIcon, FolderOpen, Trash2, Scissors } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeAI, setActiveAI, onSettingsClick }) => {
    const handleClearScreenshots = (): void => {
        if (window.confirm('Are you sure you want to permanently delete ALL FULL screenshots? (Snips will be kept)')) {
