...
const Settings: React.FC<SettingsProps> = ({ onClose }) => {
    const [settings, setSettings] = useState<{ screenshotHotkey: string; snipHotkey: string; toggleHotkey: string }>({
    ...
    const handleHotkeyChange = (key: 'screenshotHotkey' | 'snipHotkey' | 'toggleHotkey', value: string) => {
        // Conflict check
        const otherKeys = (['screenshotHotkey', 'snipHotkey', 'toggleHotkey'] as const).filter(k => k !== key);
